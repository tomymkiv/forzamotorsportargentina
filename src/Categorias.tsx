import fmCat1 from './assets/fma-categoria-1.jpeg'
        ...
        <Seccion apartado='categorias' clases='flex flex-col items-center justify-center bg-[#090909]'>
            <div className="flex flex-col gap-10 p-8 w-full">
                ...
                <SeccionPrincipal clases='flex-wrap' img1={
                    <Image href='/categorias/tca' enlace={fmCat1} clases='min-w-[80px] max-w-[140px] sm:max-w-[370px] lg:min-w-[300px] 2xl:min-w-[400px] max-w-full' />
                } />
                <div className='w-full flex items-center justify-center'>
                    <a className='flex flex-col justify-center items-center' href="https://www.instagram.com/p/DQJ0tATEQ1m/" target='_blank'>Ver en
